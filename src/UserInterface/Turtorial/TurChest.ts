...
export class TurChest extends BaseTurtorial
{


    constructor()
    {
        super(SafeKeyAsset.IMGTurChest,
          "This is a treasure chest that randomly pops up on the island. But don’t get too excited yet! You’ll need to give it four good slashes before it’ll spill out the stars hiding inside. Happy slashing!"  
        );
    }
    ...
    //         color : new pc.Color(1,1,1),
    //         textureAsset: AssetManager.getInstance().getAsset(SafeKeyAsset.IMGTurChest),
    //     })
    // }
    ...
    //         color : new pc.Color(1,1,1),
    //         text : "This is a treasure chest that randomly pops up on the island. But don’t get too excited yet! You’ll need to give it four good slashes before it’ll spill out the stars hiding inside. Happy slashing!"
    //     });
    // }
