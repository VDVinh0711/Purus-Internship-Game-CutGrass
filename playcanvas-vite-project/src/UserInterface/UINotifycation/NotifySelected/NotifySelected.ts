...
export class NotifySelected extends pc.Entity {
    ...
    private onSelectAccept: (() => void) | null = null;
    ...
    private setBtnClose(): void {
        ...
        this.btnClose.addComponent('element', {
            ...
            useInput: true,
            color: new pc.Color(1, 1, 1),
            textureAsset: AssetManager.getInstance().getAsset(SafeKeyAsset.IMGButtonCLoseSquare),
        });
    ...
    public OpenUI(text: string , callback: () => void): void {
        this.enabled = true;
        this.setTextNotify(text);
        this.onSelectAccept = callback;
        this.tweenIn.start();
